      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <h2
          className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight
                       text-gray-900 dark:text-gray-100 sm:text-4xl md:mx-auto transition-colors duration-500"
        >
          <span className="relative inline-block">
            <svg
              ...
              className="absolute top-0 left-0 z-0 hidden w-32 -mt-8 -ml-20
                         text-blue-gray-100 dark:text-blue-gray-600
                         lg:w-32 lg:-ml-28 lg:-mt-10 sm:block transition-colors duration-500"
            >
              <defs>
                <pattern
        ...
        <p className="text-base text-gray-700 dark:text-gray-300 md:text-lg transition-colors duration-500">
