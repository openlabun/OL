    ...
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            <p className="mr-1 text-gray-800">Cristian Cubillos:</p>
            <a
          ...
          <div className="flex">
            <p className="mr-1 text-gray-800">Carlos Aveldaño:</p>
            <a
              href="https://github.com/CUBILLOSCRISTIAN"
              aria-label="Github"
              title="Ir a github"
          ...
          <div className="flex">
            <p className="mr-1 text-gray-800">Nilson Diaz:</p>
            <a
              href="https://github.com/CUBILLOSCRISTIAN"
              aria-label="Github"
              title="Ir a github"
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        ...
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <a className="text-sm text-gray-600 transition-colors duration-300 hover:text-teal-accent-400">
              F.A.Q
            </a>
          </li>
          <li>
